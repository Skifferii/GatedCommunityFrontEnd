    ...
    return (
        <div className="gated-community">
            <nav className="navigation">
                ...
                {isAdmin &&   <Link to="/Addreses" className="nav-link">Addresses</Link>}
            </nav>
            <div className="content">
                <Routes>
                    ...
                    <Route path="/services" element={<AdminRoute isAdmin={isAdmin}> <OfferedServicesPage /> </AdminRoute>} />
                    <Route path="/Addreses"  element={<AdminRoute isAdmin={isAdmin}> <AddressesPage /> </AdminRoute>}/>
